...
description: "Code examples for Midnight's Compact smart contract language."
...
Compact code examples for **[Midnight Network](https://midnight.network)** smart contract development. Inspired by solidity-by-example.org.

**Compact** is Midnight's smart contract language. It compiles to zero-knowledge circuits that prove correctness without revealing private data.
