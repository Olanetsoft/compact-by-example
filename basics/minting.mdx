...
description: "Learn how to create new tokens in Compact. Master minting operations, total supply tracking, overflow protection, and access control patterns."
"og:title": "Minting Tokens Tutorial - Compact Token Creation"
"og:description": "Master token minting with safe overflow protection and supply management"
---

<Info>
  **What You'll Learn**: Minting tokens • Total supply tracking • Overflow
  protection • Access control • Supply management patterns
</Info>

## Introduction

Minting creates new tokens and adds them to circulation. It's essential for initial token distribution, reward systems, stablecoins that need to increase supply, or any economy that grows over time.

<Tip>
  **Real-world use**: Initial token distribution, reward tokens (mint for
  achievements), stablecoins (mint to maintain peg), governance token airdrops,
  NFT creation, or inflationary tokenomics.
</Tip>
