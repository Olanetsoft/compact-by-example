...
description: "Learn the token approval pattern in Compact for delegated transfers. Master how to authorize contracts and accounts to spend tokens on your behalf."
"og:title": "Token Approval Pattern - Compact Tutorial"
"og:description": "Master token approvals for DEXs, smart contracts, and delegated transfers"
---

<Info>
  **What You'll Learn**: Approval pattern • Nested Maps • Granting permissions •
  Infinite approvals • Access control
</Info>
