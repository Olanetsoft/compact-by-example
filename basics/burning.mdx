...
description: "Learn how to destroy tokens in Compact. Master burning operations, supply reduction, deflationary mechanics, and delegated burning patterns."
"og:title": "Burning Tokens Tutorial - Compact Token Destruction"
"og:description": "Master token burning for deflationary tokenomics and supply management"
---

<Info>
  **What You'll Learn**: Burning tokens • Supply reduction • Self-burn •
  Delegated burning • Deflationary patterns
</Info>

## Introduction

Burning permanently destroys tokens, removing them from circulation. It's used for deflationary tokenomics, buyback-and-burn programs, stablecoins that need to decrease supply, or removing tokens from the economy.

<Tip>
  **Real-world use**: Deflationary tokens (burn fees), governance tokens (burn
  for buybacks), stablecoins (burn to maintain peg), NFT destruction, or supply
