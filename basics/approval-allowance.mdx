...
### Challenge: Add Approval Events

<Accordion title="View Solution">

Track approval history for transparency:

```compact
// Approval history tracking
export ledger approvalHistory: Map<
    Either<ZswapCoinPublicKey, ContractAddress>,
    Opaque<"array<ApprovalRecord>">
>;
...
circuit logApproval(
    ...
    // (Implementation depends on array handling)
    // This provides an audit trail of all approvals
}
```
