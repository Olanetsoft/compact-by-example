...
description: "Learn how to use Map data structures in Compact for key-value storage. Perfect for balance tracking, ownership records, and state management in smart contracts."
"og:title": "Compact Mappings Tutorial - Map Data Structure"
"og:description": "Master Map storage in Compact for building tokens, balances, and ownership systems"
---

<Info>
  **What You'll Learn**: Map declaration • Insert and lookup • Checking
  membership • Default values • Common patterns
</Info>
...
### Challenge: Add a Transfer Function

<Accordion title="View Solution">

Combine read and write operations to transfer balances:
...
export circuit transfer(
    ...
    // Check authorization (caller must be 'from')
...
This transfer function is the foundation of token contracts!
