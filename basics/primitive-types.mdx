...
Compact provides several primitive types for building zero-knowledge circuits.rimitive Types"
sidebarTitle: "Primitive Types"
description: "Guide to Compact's primitive types: bounded integers (Uint), finite field elements (Field), byte arrays (Bytes), and opaque types for zero-knowledge circuits."
"og:title": "Compact Type System - Primitive Types for ZK Smart Contracts"
"og:description": "Uint, Field, Bytes, and Opaque types for building type-safe zero-knowledge smart contracts"

---

<Info>
  **In this tutorial**: Unsigned integers with bounded and sized types • Field
  elements for zero-knowledge computations • Bytes for fixed-length byte arrays
  • Opaque types for privacy-preserving data
</Info>
